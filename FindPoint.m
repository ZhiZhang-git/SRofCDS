%Zhi Zhang,10.10.2024, Imperial College London,
%This code is used to help the code-SpecsRepair_workloadDynaSys.m, and 
...
function [t_point,x,distan]=FindPoint (t_vector, l, l1_desti_up, l1_desti_lo, l2_desti_up, l2_desti_lo )
...
if isempty(buff_insider)~=1
    vector_insider=zeros(3,n_buff_insider);
