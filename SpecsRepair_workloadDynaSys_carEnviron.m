...
figure(1)
plot(store_traj_positi(1,:),store_traj_positi(2,:),' ','LineWidth', 3);
hold on 
plot(store_traj_positi(3,:),store_traj_positi(4,:),' ','LineWidth', 3);
hold on
plot(store_traj_positi(5,:),store_traj_positi(6,:),' ','LineWidth', 3);
hold on
plot(store_traj_positi(7,:),store_traj_positi(8,:),' ','LineWidth', 3);
hold on 
...
hold on 
plot(store_circle(1,:), store_circle(2,:), '', 'LineWidth', 5);
hold on 
plot(store_circle(3,:), store_circle(4,:), '', 'LineWidth',5);
hold on 
plot(store_circle(5,:), store_circle(6,:), '', 'LineWidth', 5);
hold on 
plot(store_circle(7,:), store_circle(8,:), '', 'LineWidth', 5);
...
%% for inner
%axis([1.245 1.455 0.98 1.168]); % [xmin xmax ymin ymax]
%xticks(1.245:0.042:1.455); % X 轴刻度每隔 2 显示一次
%yticks(0.98:0.0376:1.168);
